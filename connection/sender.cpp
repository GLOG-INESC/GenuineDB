  ...
  if (channel >= kMaxChannel) {
    ...
    switch (channel) {
      ...
      case kClockSynchronizerChannel:
        ...
        break;
      case kGLOGChannel:
        port = config_->glog_port();
        break;
      case kZipOrderChannel:
        port = config_->order_port();
        break;
      case kMultiHomeOrdererChannel:
        port = config_->mh_order_port();
        break;
      case kDeadlockResolverChannel:
        port = config_->ddr_port();
        break;
      case kGLOGStubChannel:
        port = config_->stub_port();
        break;
      default:
