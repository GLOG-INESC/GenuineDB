...
class TPCCWorkload : public Workload {
 ...
 private:
  ...
  void OrderStatus(Transaction& txn, TransactionProfile& pro, int w_id);
  void Deliver(Transaction& txn, TransactionProfile& pro, int w_id);
  void StockLevel(Transaction& txn, TransactionProfile& pro, int w_id);
